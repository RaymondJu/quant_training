...
|------|---------|--------|---------|--------|--------|--------|
| ICIR (no filter) | 19.27% | 0.953 | -23.81% | 0.809 | 58.2% | — |
| **ICIR + TopRisk** | **19.55%** | **0.977** | **-22.25%** | **0.879** | 59.2% | — |
| Ridge (no filter) | 20.20% | 1.018 | -20.85% | 0.969 | 62.2% | 46.1% |
| **Ridge + TopRisk** | 18.84% | 0.960 | **-19.20%** | **0.982** | 60.2% | — |
| XGBoost (no filter) | 21.09% | 1.000 | -22.47% | 0.938 | 59.2% | 70.1% |
| XGBoost + TopRisk | 20.41% | 0.987 | -22.43% | 0.910 | 58.2% | — |
...
- 结论：风控层对以**线性组合为主的策略（ICIR、Ridge）效果更明显**，可以在小幅牺牲年化的情况下改善回撤
